      ...
      <div className="flex flex-col">
        ...
        <div className="flex h-[91.4vh] overflow-y-hidden">
          <div
            ...
            className={`z-50  md:w-64 duration-300 sticky md:absolute top-0 left-0 w-0 ${
              show
                ? "translate-x-0 w-0 md:w-64"
                : "w-0 -translate-x-64 md:translate-x-0"
            }`}
          >
            <SideBar handleToggle={handleToggle} />
          </div>
          <div className="flex-1 p-4 h-full overflow-y-auto bg-gray-200">
            <Outlet />
          </div>
        </div>
      </div>
